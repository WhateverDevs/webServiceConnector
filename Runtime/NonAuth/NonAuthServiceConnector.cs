...
namespace WhateverDevs.WebServiceConnector.Runtime.NonAuth
{
    ...
    public class NonAuthServiceConnector : Loggable<NonAuthServiceConnector>, INonAuthWebServiceConnector
    {
        ...
        public void PostForJsonTextWithJsonParam(string jsonParam, Action<bool, string> resultCallback) =>
            CoroutineRunner.Instance.RunRoutine(PostForJsonTextWithJsonParamRoutine(jsonParam, resultCallback));
        ...
        private IEnumerator PostForJsonTextWithJsonParamRoutine(string jsonParam, Action<bool, string> resultCallback)
        {
            UnityWebRequest request = new UnityWebRequest(Config.Uri, UnityWebRequest.kHttpVerbPOST)
                                      {
                                          uploadHandler =
